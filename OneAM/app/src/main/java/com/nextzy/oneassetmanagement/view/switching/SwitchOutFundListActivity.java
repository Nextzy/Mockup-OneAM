...
public class SwitchOutFundListActivity extends BaseToolbarActivity implements NextzyService.PurchasedFundListResultCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_switch_out_fund_list);
    ...
    public void prepareView() {
        layoutContent = (LinearLayout) findViewById(R.id.switch_out_fund_detail_layout_content);
        layoutFundListContainer = (LinearLayout) findViewById(R.id.switch_out_fund_list_layout_fund_list);
        btnMoreFilter = (Button) findViewById(R.id.switch_out_fund_list_btn_more_filter);
    }
    ...
    public void updatePurchasedFundList(List<PurchasedFund> purchasedFundList) {
        for (final PurchasedFund purchasedFund : purchasedFundList) {
            View fundItemView = LayoutInflater.from(this).inflate(R.layout.view_switch_out_fund_list_item, layoutFundListContainer, false);
            CardView cvFundItem = (CardView) fundItemView.findViewById(R.id.switch_out_fund_list_cv_fund_item);
            TextView tvSymbol = (TextView) fundItemView.findViewById(R.id.switch_out_fund_list_tv_symbol);
            TextView tvName = (TextView) fundItemView.findViewById(R.id.switch_out_fund_list_tv_name);
            TextView tvAssetType = (TextView) fundItemView.findViewById(R.id.switch_out_fund_list_tv_asset_type);
            TextView tvRating = (TextView) fundItemView.findViewById(R.id.switch_out_fund_list_tv_rating);
            TextView tvInPortAmount = (TextView) fundItemView.findViewById(R.id.switch_out_fund_list_tv_in_port_amount);
            ...
            cvFundItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    openActivity(SwitchOutFundDetailActivity.class, bundle);
                }
            });
