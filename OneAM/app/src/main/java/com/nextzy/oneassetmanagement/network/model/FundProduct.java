...
/**
 * Created by trusttanapruk on 1/7/2016.
 */
...
public class FundProduct {
    ...
    public FundProduct(String symbol, String name, String assetType, String assetFirm, String riskRating, String factSheetLink, String navLatest, String cutOffTime, String starRating) {
        this.symbol = symbol;
        this.name = name;
